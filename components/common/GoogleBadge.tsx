export default function GoogleBadge() {
  return (
    <div className="flex justify-center mt-8">
      <div className="inline-flex items-center gap-2 px-4 py-2 bg-orange-700/10 border-none  rounded-full text-sm text-muted-foreground shadow-lg ">
        <svg viewBox="0 0 74 24" className="h-4 w-auto">
          <path
